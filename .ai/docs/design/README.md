...
| [`granita-one-mac-app-design-review.html`](granita-one-mac-app-design-review.html) | All of it: the reader window at its default and its minimum, the source pop-up in six states, the six-word sheet, the file selector as an inspector, the review that takes its slot, the View menu, and the four states only a Mac reader can land in. §4.1–4.3 are a *review* of built surfaces and leave with the rest. 23 September 2026, drawn against 0.19.0 for issues [#97](https://github.com/fardavide/granita/issues/97) and [#91](https://github.com/fardavide/granita/issues/91) | [`../design-mac.md`](../design-mac.md) §8 |
